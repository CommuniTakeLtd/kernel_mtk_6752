...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    test ing 
    dsi.ssc_disable = 0  
    dsi.PLL_CLOCK= 470;410;380;247;300;256;600;
    ok value : 247
    */
	//params->dsi.ssc_disable = 0 ;  //zengny add 
	//params->dsi.ssc_range = 8 ;	//zengny add 
...
void set_reset_pin_value(unsigned int x)
{
...
static void lcm_init(void)
{
	...
	MDELAY(10);
	set_reset_pin_value(1); // page 142
	MDELAY(5); 
	set_reset_pin_value(0);
	MDELAY(5); 	// page 142
	set_reset_pin_value(1);
	MDELAY(5); 
	set_reset_pin_value(0);
	MDELAY(5); 	// page 142
	set_reset_pin_value(1);
