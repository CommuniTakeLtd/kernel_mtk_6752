...
static ssize_t store_tps6128x_access(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    if(buf != NULL && size != 0)
    {
        ...
        if(size > 3)
        {
            ...
            pr_debug("[store_tps6128x_access] write tps6128x reg 0x%x with value 0x%x !\n",reg_address,reg_value);
        ...
        else
        {
            ...
            pr_debug("[store_tps6128x_access] read tps6128x reg 0x%x with value 0x%x !\n",reg_address,g_reg_value_tps6128x);
            pr_debug("[store_tps6128x_access] Please use \"cat tps6128x_access\" to get value\r\n");
        }
    }
    return size;
}
